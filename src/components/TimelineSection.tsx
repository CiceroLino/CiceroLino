...
export const TimelineSection: React.FC = () => {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      type: 'opensource',
      icon: 'fab fa-github',
      achievements: ['41 contribuições', '4 projetos principais', 'Top 10% HackerRank'],
    },
    {
      year: '2022',
      month: 'Jun - Dez',
    ...
    },
    {
      ...
      technologies: ['Algoritmos', 'Estruturas de Dados', 'Lógica de Programação', 'C++', 'Python'],
      type: 'education',
      icon: 'fas fa-graduation-cap',
      achievements: ['CR 8.5', 'Monitor de Programação', 'Participação em maratonas'],
    },
    {
      year: '2021',
      month: 'Set - Dez',
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginTop: '3rem' }}>
        ...
        >
          Estou sempre em busca de novos desafios e oportunidades para crescer. Vamos escrever o
